...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ServerDataMicroservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ServerDataMicroservice API";

        private String description = "ServerDataMicroservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ServerDataMicroservice";
